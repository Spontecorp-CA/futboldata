...
INSERT INTO `evento` VALUES (1,'Roja','Consecuencia de la doble amarilla',1,1),(2,'Amarilla','Es para indicar que un jugador ha sido oficialmente amonestado.',1,1),(3,'Roja Directa','Una tarjeta roja mostrada por el árbitro indica que un jugador ha sido expulsado de forma directa.',1,1),(4,'Gol','Un gol o tanto se marca después de que la pelota cruce completamente la línea de meta o línea de gol de una portería.',1,1),(5,'Autogol','Es cuando un jugador introduce la pelota en la portería de su propio equipo.',1,1),(6,'Sale','Es cuando un jugador es sustituido por otro jugador en el terreno de juego.',1,1),(7,'Entra','Es cuando un jugador es sustituido por otro jugador en el terreno de juego.',1,1),(8,'Gol De Tiro Libre','Pelota quieta',1,2),(9,'Gol de cabeza','',1,2),(10,'Gol con el pie','',1,2);
...
-- Dump completed on 2014-07-16 14:38:02
