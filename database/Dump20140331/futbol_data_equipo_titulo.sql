...
CREATE TABLE `equipo_titulo` (
  ...
  PRIMARY KEY (`id`,`equipo_id`,`titulo_id`),
  KEY `fk_equipo_has_titulo_titulo1_idx` (`titulo_id`),
  KEY `fk_equipo_has_titulo_equipo1_idx` (`equipo_id`),
  CONSTRAINT `fk_equipo_has_titulo_equipo1` FOREIGN KEY (`equipo_id`) REFERENCES `equipo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_equipo_has_titulo_titulo1` FOREIGN KEY (`titulo_id`) REFERENCES `titulo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-03-31 10:49:11
