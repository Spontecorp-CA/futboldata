...
CREATE TABLE `club` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_club_ciudad1_idx` (`ciudad_id`),
  CONSTRAINT `fk_club_ciudad1` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-03-31 10:49:39
