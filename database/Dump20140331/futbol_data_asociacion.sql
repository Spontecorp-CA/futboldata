...
CREATE TABLE `asociacion` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_asociacion_ciudad1_idx` (`ciudad_id`),
  CONSTRAINT `fk_asociacion_ciudad1` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-03-31 10:48:46
