...
CREATE TABLE `competicion_arbitro` (
  ...
  PRIMARY KEY (`id`,`competicion_id`,`arbitro_id`),
  KEY `fk_competicion_has_arbitro_arbitro1_idx` (`arbitro_id`),
  KEY `fk_competicion_has_arbitro_competicion1_idx` (`competicion_id`),
  CONSTRAINT `fk_competicion_has_arbitro_arbitro1` FOREIGN KEY (`arbitro_id`) REFERENCES `arbitro` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_competicion_has_arbitro_competicion1` FOREIGN KEY (`competicion_id`) REFERENCES `competicion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-03-31 10:49:15
