...
CREATE TABLE `equipo_premio` (
  ...
  PRIMARY KEY (`id`,`equipo_id`,`premio_id`),
  KEY `fk_equipo_has_premio_premio1_idx` (`premio_id`),
  KEY `fk_equipo_has_premio_equipo1_idx` (`equipo_id`),
  CONSTRAINT `fk_equipo_has_premio_equipo1` FOREIGN KEY (`equipo_id`) REFERENCES `equipo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_equipo_has_premio_premio1` FOREIGN KEY (`premio_id`) REFERENCES `premio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-03-31 10:48:47
