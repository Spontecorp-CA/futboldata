...
CREATE TABLE `persona` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_persona_red_social1_idx` (`red_social_id`),
  CONSTRAINT `fk_persona_red_social1` FOREIGN KEY (`red_social_id`) REFERENCES `red_social` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-03-31 11:14:09
