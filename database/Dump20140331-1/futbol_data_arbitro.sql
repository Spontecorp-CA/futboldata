...
CREATE TABLE `arbitro` (
  ...
  `arbitrocol` varchar(45) DEFAULT NULL,
  ...
  CONSTRAINT `fk_arbitro_persona1` FOREIGN KEY (`persona_id`) REFERENCES `persona` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_arbitro_asociacion1` FOREIGN KEY (`asociacion_id`) REFERENCES `asociacion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-03-31 11:14:29
