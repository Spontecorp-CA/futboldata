...
CREATE TABLE `club` (
  ...
  KEY `fk_club_red_social1_idx` (`red_social_id`),
  CONSTRAINT `fk_club_direccion1` FOREIGN KEY (`direccion_id`) REFERENCES `direccion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_club_red_social1` FOREIGN KEY (`red_social_id`) REFERENCES `red_social` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-04-08 17:26:07
