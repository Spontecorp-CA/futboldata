...
CREATE TABLE `club_cancha` (
  ...
  PRIMARY KEY (`id`,`club_id`,`cancha_id`),
  KEY `fk_club_has_cancha_cancha1_idx` (`cancha_id`),
  KEY `fk_club_has_cancha_club1_idx` (`club_id`),
  CONSTRAINT `fk_club_has_cancha_club1` FOREIGN KEY (`club_id`) REFERENCES `club` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_club_has_cancha_cancha1` FOREIGN KEY (`cancha_id`) REFERENCES `cancha` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-04-08 17:26:09
