...
CREATE TABLE `temporada` (
  ...
  CONSTRAINT `fk_temporada_competicion1` FOREIGN KEY (`competicion_id`) REFERENCES `competicion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-04-08 17:26:05
