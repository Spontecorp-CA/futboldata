...
CREATE TABLE `equipo_cancha` (
  ...
  PRIMARY KEY (`id`,`equipo_id`,`cancha_id`),
  KEY `fk_equipo_has_cancha_cancha1_idx` (`cancha_id`),
  KEY `fk_equipo_has_cancha_equipo1_idx` (`equipo_id`),
  CONSTRAINT `fk_equipo_has_cancha_equipo1` FOREIGN KEY (`equipo_id`) REFERENCES `equipo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_equipo_has_cancha_cancha1` FOREIGN KEY (`cancha_id`) REFERENCES `cancha` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
