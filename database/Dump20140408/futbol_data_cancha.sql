...
CREATE TABLE `cancha` (
  ...
  `coordenada_long` int(11) DEFAULT NULL,
  `coordenada_lat` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_cancha_direccion1_idx` (`direccion_id`),
  CONSTRAINT `fk_cancha_direccion1` FOREIGN KEY (`direccion_id`) REFERENCES `direccion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
