...
@FacesConverter(forClass = Jornada.class)
    public class JornadaConverter implements Converter {
        JornadaFacade controller = new JornadaFacade();
        @Override
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Jornada) {
                ...
                logger.error("object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Jornada.class.getName()});
                //java.util.logging.Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Jornada.class.getName()});
                return null;
            }
        }
